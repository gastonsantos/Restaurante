...
public void TestQueCuentaSalEnPlato(){
	...
	Ingredientes ingrediente1 = new Ingredientes("Huevo", 1.0, 1.0);
	Ingredientes ingrediente2 = new Ingredientes("Queso", 4.0, 4.0);
...
public void TestQueVerificaPlatoAptoParaHipertensos(){
	...
	Ingredientes ingrediente2 = new Ingredientes("Queso", 0.0, 0.2);
